...
class GridTrader(Algorithm):
    """Grid trading bot using gRPC protocol."""
    def __init__(self):
        super().__init__("Grid Trader")
        self.grid_orders = {}
        self.grid_levels = []
        self.symbol = None
        self.exchanges = None
        ...
        schema = {
            ...
            "properties": {
                ...
                "exchange": 
                {
                    ...
                    "value": "BinanceUS"},
                "upper_price": {
                    "title": "Upper Price Delta",
                    "description": "The upper price limit for the grid in % away from best bid. ex. 0.01 for a pair bid at $99,000 would make the upper price $99,990.",
                    "type": "number", 
                    "options": "0.0 .. 1.0",
                    "value": 0.01},
                "lower_price": {
                    "title": "Lower Price Delta",
                    "description": "The lower price limit for the grid in % away from upper price. ex. 0.01 for an upper price of $99,990 would make the lower price $98,990.10.",
                    "type": "number",
                    "options": "0.0 .. 1.0", 
                    "value": 0.01},
                "offer_threshold": {
